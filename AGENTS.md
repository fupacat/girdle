...
src/girdle/hygiene.py | python | 249L | _read_text, HygieneResult, _first_existing, check_editorconfig, check_gitattributes, check_precommit, check_agent_sandbox_bootstrap, check_gitignore, check_codeowners, check_readme, check_contributing, build_hygiene
