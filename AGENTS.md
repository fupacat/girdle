...
src/girdle/vault.py | python | 382L | DanglingWatchError, _describe_watch, WatchEntry, Note, _IndentedDumper, _parse_frontmatter, _render_frontmatter, load_note, load_all_notes, current_hash, _note_rel, _write_note, _git_add, _staged_files, _content_signature, _rename_source, _show_at_head, _head_signature, _meaningfully_edited, reconcile, CheckResult, check, ack, render_vault_index, inject_vault_index
